...
func DeclarePaymentTopology(ch *amqp.Channel) error {
	if err := ch.ExchangeDeclare(PaymentExchange, "direct", true, false, false, false, nil); err != nil {
		return err
	}

	if err := ch.ExchangeDeclare(PaymentDLX, "direct", true, false, false, false, nil); err != nil {
		return err
	}
	...
	if err := ch.QueueBind(PaymentCompletedDLQ, PaymentCompletedDLQRouting, PaymentDLX, false, nil); err != nil {
		return err
	}
	...
	return ch.QueueBind(PaymentCompletedQueue, PaymentCompletedRoutingKey, PaymentExchange, false, nil)
}
